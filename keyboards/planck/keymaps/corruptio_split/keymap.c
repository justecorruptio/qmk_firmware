...
[_QWERTY] = LAYOUT_planck_grid(
   ...
   mS(KC_Z),    KC_X,    KC_C,    KC_V,mC(KC_B), XXXXXXX, XXXXXXX,mC(KC_N),    KC_M, KC_COMM,  KC_DOT,mS(KC_QUOT),
    XXXXXXX,  XXXXXXX, XXXXXXX, KC_ESC,  l_BSPC,   KC_NO,   KC_NO,   r_SPC,  KC_TAB, XXXXXXX, XXXXXXX, XXXXXXX
),
...
[_RAISE] = LAYOUT_planck_grid(
    KC_EXLM,   KC_AT, KC_HASH,  KC_DLR, KC_PERC, XXXXXXX, XXXXXXX, KC_LALT, _______,   KC_UP, _______, _______,
    KC_CIRC, KC_AMPR, KC_ASTR, KC_UNDS, KC_MINS, XXXXXXX, XXXXXXX, KC_LGUI, KC_LEFT, KC_DOWN, KC_RGHT, KC_COLN,
     KC_GRV, KC_TILD, KC_SLSH,  KC_EQL, KC_PLUS, XXXXXXX, XXXXXXX, KC_LCTL, _______, _______, _______, KC_SCLN,
