...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, KC_CIRC, KC_AMPR, KC_ASTR, KC_UNDS, KC_LPRN, KC_RPRN,    KC_4,    KC_5,    KC_6, KC_MINS, _______,
    _______,  KC_GRV, KC_TILD, KC_PERC,  KC_EQL, KC_LBRC, KC_RBRC,    KC_1,    KC_2,    KC_3, _______, KC_PIPE,
