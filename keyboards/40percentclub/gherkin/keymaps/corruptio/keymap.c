...
[1] = LAYOUT_ortho_3x10(
    KC_1,    KC_2,    KC_3, KC_PIPE, XXXXXXX, XXXXXXX,  KC_ESC,   KC_UP,  KC_TAB, KC_SCLN,
    KC_4,    KC_5,    KC_6, KC_BSLS, XXXXXXX, XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT, KC_COLN,
    KC_7,    KC_8,    KC_9,    KC_0, _______, _______, KC_LCTL, KC_LGUI, KC_LALT, KC_LSFT
),

[2] = LAYOUT_ortho_3x10(
 KC_EXLM, KC_QUES, KC_PLUS, KC_MINS,  KC_EQL,  XXXXXXX, KC_LPRN, KC_RPRN, KC_TILD,  KC_GRV,
 KC_CIRC, KC_AMPR, KC_ASTR, KC_SLSH, KC_PERC,  XXXXXXX, KC_LCBR, KC_RCBR, KC_QUOT, KC_DQUO,
  KC_DLR,   KC_AT, KC_HASH, XXXXXXX, _______,  _______, KC_LBRC, KC_RBRC,   KC_LT,   KC_GT
),
